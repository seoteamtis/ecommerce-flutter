...
//           // Agar purane code mein border ya shadow hai toh wo yahan rehne dein
//           border: Border.all(color: Theme.of(context).colorScheme.onTertiary.withValues(alpha: 0.1)),
//         ),
//         child: Column(
//           crossAxisAlignment: CrossAxisAlignment.start,
//           children: [
//
//             // --- IMAGE SECTION (Fixed Height for Same Size) ---
//             Expanded(
//               child: Stack(
//                 children: [
//                   ClipRRect(
...
//                       fit: BoxFit.cover, // Sab image same size me fit hongi
//                     ),
//                   ),
//
//                   // Discount Tag
//                   if ((product.discount! > 0) || (product.clearanceSale?.discountAmount ?? 0) > 0)
//                     Positioned(
//                       top: 10, left: 10,
//                       child: Container(
//                         padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
//                         decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(2)),
//                         child: Text('discountings', style: textBold.copyWith(fontSize: 9, color: Colors.black)),
//                       ),
//                     ),
//                 ],
//               ),
...
//                         ),
//                         style: textBold.copyWith(fontSize: 16, color: Colors.black),
//                       ),
//
//                       SizedBox(
//                         height: 25, width: 25,
                  ...
                  if ((product.discount! > 0) || (product.clearanceSale?.discountAmount ?? 0) > 0)
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          'discountings',
                          style: robotoBold.copyWith(fontSize: 9, color: Colors.black),
                        ),
                      ),
                    ),
                ],
